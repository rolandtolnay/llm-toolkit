...
description: Create and configure Claude Code subagents for the Task tool. Use when defining agent types in agents/ config files, setting up agent tools and prompts, or launching specialized agents with the Task tool.
---
...
For XML structure principles and token efficiency details, see @skills/create-agent-skill/references/use-xml-tags.md - the same principles apply to subagents.
</critical_rule>
</subagent_xml_structure>
