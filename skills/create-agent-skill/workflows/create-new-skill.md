...
Skills automatically register as slash commands based on the `name` field in frontmatter. No separate command file needed.
...
- [ ] Tested with real invocation (skill auto-registers as /{name})
</success_criteria>
